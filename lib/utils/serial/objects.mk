...
carray-fdt_serial_drivers-$(CONFIG_FDT_SERIAL_SUNXI) += fdt_serial_sunxi
libsbiutils-objs-$(CONFIG_FDT_SERIAL_SUNXI) += serial/fdt_serial_sunxi.o
...
libsbiutils-objs-$(CONFIG_SERIAL_SUNXI) += serial/sunxi-uart.o
